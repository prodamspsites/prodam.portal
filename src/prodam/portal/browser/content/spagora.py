...
url_direct = {
  'pref-sp': 'http://www.capital.sp.gov.br/portal/',
...
class FindAeportSituation(object):
  ...
  def getSituation(self):
    ...
    for aeport in self.list_aeport.keys():
      list_situation.append({
                              'aeport': self.list_aeport.get(aeport), 
