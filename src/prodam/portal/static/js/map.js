...
$(document).ready(function(){
    ...
    $('.roteOption input').click(function(){
        roteOption = $(this).attr('id');
    });
    roteOption = "rb-car" ;
    $("form").submit(function(event) {
        if (roteOption == 'rb-trans'){
            direction = google.maps.TravelMode.TRANSIT ;
        }
        else if (roteOption == 'rb-pe'){
            direction = google.maps.TravelMode.WALKING ;
        }
        else if(roteOption == 'rb-car'){
            direction = google.maps.TravelMode.DRIVING ;
        }
